...
(
   ...
   constraint PK_DIM_TIME01 primary key (TIME_ID)
    )
...
ALTER USER DW_DATA quota unlimited on LW_09;
ALTER USER DW_DATA quota unlimited on LW_09_1;
ALTER USER DW_DATA quota unlimited on LW_09_2;

INSERT INTO calendar01
SELECT
...
ALTER TABLE calendar01
MERGE PARTITIONS PART_1, PART_2 INTO PARTITION PART_3;

ALTER TABLE calendar01 MOVE PARTITION PART_3
    TABLESPACE lw_09_1 NOLOGGING COMPRESS;


ALTER TABLE calendar01 SPLIT PARTITION PART_3
    AT (TO_DATE('10-05-2000', 'MM-DD-YYYY'))
    INTO(PARTITION PART_1, PARTITION PART_2);
    
ALTER TABLE calendar01 TRUNCATE PARTITION PART_1;

ALTER TABLE calendar01 drop PARTITION PART_1;